...
def enemy_encounter(): 
    ...
    if flee_or_fight == "1" or flee_or_fight == "Fight" or flee_or_fight == "fight": 
        ...
        if classes.selected_player.HP / random_enemy.STR < random_enemy.HP / classes.selected_player.STR: 
            ...
            print(f"{RED}{random_enemy.name}{RESET} was stronger than you! You lost {enemy_hp_damage} HP.")
        elif classes.selected_player.HP / random_enemy.STR > random_enemy.HP / classes.selected_player.STR: 
            print(f"Congratulations! You were stronger than {RED}{random_enemy.name}{RESET}")
            classes.p1.LVL += 1
            classes.p2.LVL += 1
            ...
            print(f"You and {RED}{random_enemy.name}{RESET} were evenly strong. {RED}{random_enemy.name}{RESET} fled!")
    elif flee_or_fight == "2" or flee_or_fight =="Flee" or flee_or_fight == "flee":  
        print(f"You escaped {RED}{random_enemy.name}{RESET}")
